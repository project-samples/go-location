...
type AllowConf struct {
	...
	Port              string   `mapstructure:"port" json:"port,omitempty" gorm:"column:port" bson:"port,omitempty" dynamodbav:"port,omitempty" firestore:"port,omitempty"`
	...
	AllowOrigins      []string `mapstructure:"allow_origins" json:"allowOrigins,omitempty" gorm:"column:alloworigins" bson:"allowOrigins,omitempty" dynamodbav:"allowOrigins,omitempty" firestore:"allowOrigins,omitempty"`
	...
	SecurePort        string   `mapstructure:"secure_port" json:"securePort,omitempty" gorm:"column:secureport" bson:"securePort,omitempty" dynamodbav:"securePort,omitempty" firestore:"securePort,omitempty"`
	Cert              string   `mapstructure:"cert" json:"cert,omitempty" gorm:"column:cert" bson:"cert,omitempty" dynamodbav:"cert,omitempty" firestore:"cert,omitempty"`
	...
	Https             bool     `mapstructure:"https" json:"https,omitempty" gorm:"column:https" bson:"https,omitempty" dynamodbav:"https,omitempty" firestore:"https,omitempty"`
}
